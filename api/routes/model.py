...
def list_paginate():
    ...
    results = Model.query.paginate(page=offset, per_page=limit)
    total = Model.query.count()
    response = Pagination(results, offset, limit, total)
...
def delete(id: int):
    ...
    return "Model não encontrado", status.HTTP_404_NOT_FOUND
